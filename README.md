...
- 3D: physically based materials with clearcoat, sheen, subsurface and
  ...
  lighting, fog; reflection probes, baked light probe grids and
  screen-space reflections; order-independent transparency; instancing,
  frustum culling and levels of detail; billboards, decals, outlines and
  x-ray; dynamic meshes and terrain; SSAO, bloom, FXAA, tone mapping and
  colour
