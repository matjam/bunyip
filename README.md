...
| `go run ./examples/physics3d` | five hundred cubes with wood grain, brushed metal, textured plastic and other materials dropped into a concrete pen, with a raycast highlighting the one under the pointer |
